...
from AttenPacker.common.transforms import matrix_to_quaternion
...
from AttenPacker.common.helpers import rotation_from_3_points, exists
from AttenPacker.features.feature import Feature
from AttenPacker.features.feature_config import InputFeatureConfig, FeatureTy, FeatureName
from AttenPacker.features.feature_utils import res_ty_encoding, rel_pos_encoding, bb_dihedral_encoding, \

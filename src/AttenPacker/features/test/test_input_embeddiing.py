...
from AttenPacker.features.feature_config import InputFeatureConfig, AA_ALPHABET
from AttenPacker.features.feature_generator import DefaultFeatureGenerator

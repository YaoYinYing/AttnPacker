...
from AttenPacker.common.protein_constants import AA_ALPHABET
from AttenPacker.features.feature import Feature
from AttenPacker.features.feature_config import (
    InputFeatureConfig,
    FeatureTy,
    FeatureName,
    FeatureEmbeddingTy,
...
from AttenPacker.features.feature_utils import fourier_encode

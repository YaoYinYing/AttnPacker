...
from AttenPacker.networks.common.of_rigid_utils import Rigid
from AttenPacker.networks.fa_coord.coords_from_angles import FACoordModule
import AttenPacker.common.protein_constants as pc
from einops import rearrange, repeat  # noqa
from AttenPacker.common.helpers import default, safe_normalize, safe_norm, exists
import torch.nn.functional as F  # noqa
from typing import Union, Optional, List, Tuple, Any, Dict
from AttenPacker.networks.loss.side_chain_loss import SideChainDihedralLoss
from AttenPacker.protein_utils.sidechains.sidechain_rigid_utils import atom37_to_torsion_angles
from AttenPacker.protein_utils.sidechains.sidechain_utils import align_symmetric_sidechains, swap_symmetric_atoms
from AttenPacker.common.rigids import Rigids as SimpleRigids
from AttenPacker.networks.common.helpers.neighbor_utils import get_neighbor_info, batched_index_select

...
from AttenPacker.common.helpers import safe_normalize, default, masked_mean
...
from AttenPacker.protein_utils.sidechains.sidechain_utils import align_symmetric_sidechains, get_sc_dihedral

...
from AttenPacker.common.protein_constants import N_BB_ATOMS
from AttenPacker.common.helpers import default
from AttenPacker.protein_utils.dihedral.orientation_utils import signed_dihedral_4, get_bb_dihedral

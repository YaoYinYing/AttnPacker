...
from AttenPacker.models.fbb_design.train_utils import TrainDesign
from AttenPacker.networks.geometric_gt.geom_gt_config import add_gt_options, get_configs as get_gt_configs
from AttenPacker.networks.loss.loss_fn import LossConfig, DefaultLossFunc
...
from AttenPacker.models.fbb_design.fbb_model import FBBDesigner
from AttenPacker.networks.se3_transformer.se3_transformer_config import SE3TransformerConfig, add_se3_options
...
from AttenPacker.common.data.data_types.protein import Protein
from AttenPacker.common.protein_constants import AA_TO_INDEX
